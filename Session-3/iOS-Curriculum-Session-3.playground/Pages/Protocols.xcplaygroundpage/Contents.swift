 ...
 */
let pythons = Array.init(arrayLiteral: "Eric", "Graham", "John", "Michael", "Terry", "Terry")
...
/*:
 ...
 First, here’s a protocol called Animal that requires any conforming type to have an id property and an eat() method:
 */
protocol Animal {
